...
export function AssessmentViewerPage() {
  ...
  return <main className="experiment-page"><header><button className="logo-button" onClick={() => navigate('/')}>Blueprint Lab</button><span>Run viewer</span></header><div className="viewer-shell">
  ...
  </div><button className="viewer-back-button" onClick={() => navigate(`/experiments/${id}/progress`)}>Back</button></main>
}
